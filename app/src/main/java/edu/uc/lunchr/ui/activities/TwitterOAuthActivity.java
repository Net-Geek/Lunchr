 ...
 * 4. Return to the {@link edu.uc.lunchr.ui.activities.LoginActivity} with the new access token
 */
public class TwitterOAuthActivity extends Activity {
    ...
    private void getTwitterOAuthTokenAndLogin(final RequestToken requestToken, final String oauthVerifier) {
        // once a user authorizes the application, get the auth token and return to the Login
